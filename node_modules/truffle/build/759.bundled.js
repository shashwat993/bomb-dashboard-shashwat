...
const compileWithPragmaAnalysis = async ({ paths, options }) => {
    ...
    for (const path of filteredPaths) {
        ...
        const { allSources } = await Profiler.requiredSourcesForSingleFile(options.with({
            path,
        ...
        const semverExpressions = await getSemverExpressions(Object.values(allSources));
...
class Docker {
    ...
    async list() {
        ...
        const latestRelease = (_a = semver_1.default.coerce(await iter_tools_1.asyncFirst(forkedReleases))) === null || _a === void 0 ? void 0 : _a.version;
        return {
            prereleases,
            releases,
            latestRelease
        ...
        return (async function* () {
            do {
                try {
                    ...
                    results, 
                    // next page url
                    next } } = await client.get(nextUrl, { maxRedirects: 50 });
...
class VersionRange {
    ...
    async getAndCacheSolcByUrl(fileName, index = 0) {
        ...
        try {
            const response = await axios_1.default.get(url, { maxRedirects: 50 });
...
const Compile = {
    ...
    async sourcesWithDependencies({ paths, options }) {
        ...
        const { allSources, compilationTargets } = await Profiler.requiredSources(options.with({
            paths: solidityPaths,
            base_path: options.contracts_directory,
            resolver: options.resolver,
            compiler: {
...
class TruffleConfig {
    ...
    with(obj) {
        ...
        const newConfig = lodash_assignin_1.default(Object.create(TruffleConfig.prototype), current, normalized);
...
"use strict";
module.exports = JSON.parse("{\"name\":\"@truffle/core\",\"description\":\"Core code for Truffle command line tool\",\"author\":\"consensys.net\",\"homepage\":\"https://github.com/trufflesuite/truffle#readme\",\"repository\":{\"type\":\"git\",\"url\":\"https://github.com/trufflesuite/truffle.git\",\"directory\":\"packages/core\"},\"bugs\":{\"url\":\"https://github.com/trufflesuite/truffle/issues\"},\"version\":\"5.4.32\",\"bin\":{\"truffle\":\"./cli.js\",\"truffle-exec\":\"./exec.js\"},\"scripts\":{\"prepare\":\"exit 0\",\"test\":\"mocha ./test/** ./test/**/*\"},\"dependencies\":{\"@truffle/artifactor\":\"^4.0.139\",\"@truffle/box\":\"^2.1.37\",\"@truffle/codec\":\"^0.11.25\",\"@truffle/compile-solidity\":\"^6.0.11\",\"@truffle/config\":\"^1.3.17\",\"@truffle/contract\":\"^4.4.7\",\"@truffle/debug-utils\":\"^6.0.7\",\"@truffle/debugger\":\"^9.2.14\",\"@truffle/decoder\":\"^5.1.10\",\"@truffle/deployer\":\"^3.2.64\",\"@truffle/environment\":\"^0.2.91\",\"@truffle/error\":\"^0.0.15\",\"@truffle/expect\":\"^0.0.19\",\"@truffle/fetch-and-compile\":\"^0.3.1\",\"@truffle/interface-adapter\":\"^0.5.11\",\"@truffle/migrate\":\"^3.2.64\",\"@truffle/plugins\":\"^0.2.5\",\"@truffle/preserve\":\"^0.2.6\",\"@truffle/preserve-fs\":\"^0.2.6\",\"@truffle/preserve-to-buckets\":\"^0.2.6\",\"@truffle/preserve-to-filecoin\":\"^0.2.7\",\"@truffle/preserve-to-ipfs\":\"^0.2.7\",\"@truffle/provider\":\"^0.2.45\",\"@truffle/provisioner\":\"^0.2.40\",\"@truffle/require\":\"^2.0.86\",\"@truffle/resolver\":\"^8.0.5\",\"@truffle/source-fetcher\":\"^0.6.2\",\"@truffle/workflow-compile\":\"^4.0.1\",\"chai\":\"^4.2.0\",\"colors\":\"1.4.0\",\"command-exists\":\"^1.2.8\",\"conf\":\"^10.0.2\",\"cpr\":\"^3.0.1\",\"debug\":\"^4.3.1\",\"del\":\"^2.2.0\",\"ethereum-cryptography\":\"^0.1.3\",\"ethereumjs-wallet\":\"^1.0.1\",\"ethpm\":\"0.0.19\",\"ethpm-registry\":\"0.1.0-next.3\",\"fs-extra\":\"^9.1.0\",\"ganache\":\"7.0.1\",\"get-port\":\"^5.1.1\",\"get-random-values\":\"^1.2.2\",\"glob\":\"^7.1.6\",\"hdkey\":\"^1.1.0\",\"inquirer\":\"^7.0.0\",\"js-interpreter\":\"2.2.0\",\"mocha\":\"8.1.2\",\"node-emoji\":\"^1.8.1\",\"ora\":\"^3.4.0\",\"original-require\":\"^1.0.1\",\"sane\":\"^4.0.2\",\"semver\":\"^7.3.4\",\"source-map-support\":\"^0.5.19\",\"spawn-args\":\"^0.1.0\",\"tmp\":\"^0.2.1\",\"universal-analytics\":\"^0.4.17\",\"web3\":\"1.5.3\",\"web3-utils\":\"1.5.3\",\"xregexp\":\"^4.2.4\",\"yargs\":\"^8.0.2\"},\"devDependencies\":{\"@truffle/blockchain-utils\":\"^0.1.0\",\"app-module-path\":\"^2.2.0\",\"chai-as-promised\":\"^7.1.1\",\"memorystream\":\"^0.3.1\",\"sinon\":\"^9.0.2\"},\"publishConfig\":{\"access\":\"public\"},\"authors\":[{\"name\":\"Tim Coulter\",\"email\":\"tim@trufflesuite.com\",\"url\":\"https://github.com/tcoulter\"}],\"namespace\":\"consensys\",\"gitHead\":\"409dadef3759efac8265de7dfcbedf0c066a0a0e\"}");
